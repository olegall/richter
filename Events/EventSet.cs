...
namespace Events
{
    ...
    public sealed class EventSet
    {
        ...
        public void Raise(EventKey eventKey, Object sender, EventArgs e)
        {
            ...
            if (d != null)
            {
                // Из-за того что словарь может содержать несколько разных типов делегатов, невозможно создать вызов делегата, безопасный по отношению к типу, во время компиляции.
                // Я вызываю метод DynamicInvoke типа System.Delegate, передавая ему параметры метода обратного вызова в виде массива объектов.
                // DynamicInvoke будет контролировать безопасность типов параметров для вызываемого метода обратного вызова. Если будет найдено несоответствие типов, выдается исключение.

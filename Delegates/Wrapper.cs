...
namespace Delegates
{
    ...
    class Wrapper
    {
        ...
        // Вспомогательному классу присваивается необычное имя, чтобы/ избежать конфликтов и предотвратить доступ из класса AClass
        //[CompilerGenerated]
        //private sealed class <>c__DisplayClass2 : Object 
        //{
        //    // В коде обратного вызова для каждой локальной переменной используется одно открытое поле
